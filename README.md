...
[comment]: # "https://www.youtube.com/embed/t6An3BgI6_k"
...
1. Install and activate Backup Copilot on your WordPress site
2. Click **Create Backup** to save a complete WordPress backup snapshot
3. Add optional notes to identify your backup points
4. Click **Restore** anytime to roll back your WordPress site
5. Use **Export** to download backups for WordPress migration to new hosts
...
2. Click **Create Backup** to create your first WordPress backup
3. View all backups in the **Manage Backups** table
4. Click **Restore** to roll back WordPress to any backup point
...
1. **Create Backup** - Saves WordPress backup on your server for quick restore
2. **Export Backup** - Downloads complete WordPress backup to your computer
3. **Import Backup** - Upload WordPress backup file from another site
4. **Restore Backup** - Roll back WordPress site to any backup point
5. **Download Files** - Get individual components (database .sql, files .zip)
6. **Delete Backup** - Remove old WordPress backups to save server space
...
1. Edit any backup and select **Advanced Options**
2. Choose components: Database, WP-Content, Media Library, Themes, Plugins
3. Include configuration files: .htaccess, wp-config.php (export only)
4. Enable Find & Replace URLs for WordPress migration (Pro)

**WordPress Restore Process:**

1. Go to **Backup Copilot > Manage Backups**
2. Find the backup point you want to restore
3. Click the **Restore** button
4. Confirm the restoration
5. WordPress automatically restores database and files

**WordPress Site Migration:**

1. On old site: Click **Export Backup** to download
2. On new WordPress installation: Install Backup Copilot
3. Click **Import Backup** and upload the file
4. Click **Restore** to complete WordPress migration

== Features & Limitations ==

The [**Backup Copilot**](https://backupcopilotplugin.com/?utm_source=bkpc&utm_medium=free_plugin&utm_campaign=readme_txt) WordPress backup plugin allows you to:
...
Find step-by-step setup guides, video tutorials, WordPress backup best practices, and migration instructions on the [**Backup Copilot Documentation**](https://backupcopilotplugin.com/help) page.

== Backup Copilot Pro ==

If you're using the free WordPress backup plugin from WordPress.org and want Pro features, you can purchase the premium version on the [**Backup Copilot Pro**](https://backupcopilotplugin.com/?utm_source=bkpc&utm_medium=free_plugin&utm_campaign=readme_txt) website.
...
Visit the [**Support Forum**](https://wordpress.org/support/plugin/backup-copilot/) to share your questions or requests.
...
Automatic WordPress backup scheduling requires [**Backup Copilot Pro**](https://backupcopilotplugin.com/?utm_source=bkpc&utm_medium=free_plugin&utm_campaign=readme_txt). Set hourly, daily, weekly, or monthly backup schedules with automatic cloud storage sync.

### Can I backup WordPress to cloud storage?

Cloud storage (Dropbox, Google Drive, OneDrive) is available in [**Backup Copilot Pro**](https://backupcopilotplugin.com/?utm_source=bkpc&utm_medium=free_plugin&utm_campaign=readme_txt). The free version stores WordPress backups on your server only.
...
The free version supports WordPress backups up to 500MB (optimal for shared hosting). [**Backup Copilot Pro**](https://backupcopilotplugin.com/?utm_source=bkpc&utm_medium=free_plugin&utm_campaign=readme_txt) removes this limit with resumable uploads for large WordPress sites.
...
1. screenshot-1.(png) - Backup Copilot main dashboard
2. screenshot-2.(png) - Create WordPress backup interface
3. screenshot-3.(png) - Manage backups table view
4. screenshot-4.(png) - WordPress backup advanced options
5. screenshot-5.(png) - Restore WordPress backup confirmation
6. screenshot-6.(png) - WordPress backup progress tracking
...
4. Navigate to **Backup Copilot** in the admin menu

= Manual Installation =

1. Download the WordPress backup plugin ZIP file
2. Upload the `backup-copilot` folder to `/wp-content/plugins/`
3. Go to **Plugins** in WordPress admin
4. Activate **Backup Copilot**
5. Navigate to **Backup Copilot** in the admin menu

= After Activation =

1. Click **Backup Copilot** in the WordPress admin menu
2. Verify all system checks show **[OK]** status
3. Click **Create Backup** to create your first WordPress backup
4. Add optional notes to identify this backup point
5. Review the backup in the **All Backups** table
6. Test the restore process with a test WordPress backup

**Quick Start:**

1. Navigate to **Backup Copilot**
2. Click **Create Backup**
3. Wait for WordPress backup to complete
...
Upgrade to [**Backup Copilot Pro**](https://backupcopilotplugin.com/?utm_source=bkpc&utm_medium=free_plugin&utm_campaign=readme_txt) for cloud storage, automated WordPress backup scheduling, email notifications, and priority support!
